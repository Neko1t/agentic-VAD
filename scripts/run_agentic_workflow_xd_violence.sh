...
export DATASET_DIR="${DATASET_DIR:-${REPO_ROOT}/data/xd_violence}"
...
export OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/data/agentic_outputs/xd_violence}"
export MEMORY_DIR="${MEMORY_DIR:-${REPO_ROOT}/data/agentic_memory/xd_violence}"
