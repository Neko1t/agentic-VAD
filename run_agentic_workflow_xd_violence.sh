...
# XD-Violence template launcher for the agentic VAD workflow.
#
# Linux:
...
export DATASET_DIR="${DATASET_DIR:-${SCRIPT_DIR}/data/xd_violence}"
...
export OUTPUT_DIR="${OUTPUT_DIR:-${SCRIPT_DIR}/data/agentic_outputs/xd_violence}"
export MEMORY_DIR="${MEMORY_DIR:-${SCRIPT_DIR}/data/agentic_memory/xd_violence}"
